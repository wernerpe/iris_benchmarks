...
from pydrake.all import (IrisInConfigurationSpace,
                        #  RayIris,
                         ...
                         Hyperellipsoid,
                         IpoptSolver,
                         SolverOptions, IrisNp2Options, IrisNp2SamplingStrategy, IrisNp2)
...
def get_iris_handle(env_name,
    ...
    def iris_handle(pt, random_seed = options.sampled_iris_options.random_seed):
    ...
    return iris_handle, options.sampled_iris_options.configuration_space_margin, settings_hash, options.sampled_iris_options.random_seed, num_trials